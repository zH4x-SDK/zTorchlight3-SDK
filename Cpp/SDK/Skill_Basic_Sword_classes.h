...
// BlueprintGeneratedClass Skill_Basic_Sword.Skill_Basic_Sword_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Skill_Basic_Sword.Skill_Basic_Sword_C");
		return ptr;
	}

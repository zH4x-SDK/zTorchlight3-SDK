...
struct UForgedResourceBar_C_GetTooltipAnchor_Params
{
...
struct UForgedResourceBar_C_GetResourceAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function ForgedResourceBar.ForgedResourceBar_C.Construct
struct UForgedResourceBar_C_Construct_Params
{
};

// Function ForgedResourceBar.ForgedResourceBar_C.ExecuteUbergraph_ForgedResourceBar
struct UForgedResourceBar_C_ExecuteUbergraph_ForgedResourceBar_Params
{

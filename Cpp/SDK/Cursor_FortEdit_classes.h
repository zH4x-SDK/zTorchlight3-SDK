...
// WidgetBlueprintGeneratedClass Cursor_FortEdit.Cursor_FortEdit_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Cursor_FortEdit.Cursor_FortEdit_C");
		return ptr;
	}

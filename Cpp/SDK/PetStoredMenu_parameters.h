...
struct UPetStoredMenu_C_GetMenuButtonList_Params
{
...
struct UPetStoredMenu_C_GetMenuHeader_Params
{
...
struct UPetStoredMenu_C_GetShowAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function PetStoredMenu.PetStoredMenu_C.GetCanvasPanel
struct UPetStoredMenu_C_GetCanvasPanel_Params
{
...
struct UPetStoredMenu_C_BlueprintOnShown_Params
{
};

// Function PetStoredMenu.PetStoredMenu_C.ExecuteUbergraph_PetStoredMenu
struct UPetStoredMenu_C_ExecuteUbergraph_PetStoredMenu_Params
{

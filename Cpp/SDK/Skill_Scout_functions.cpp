...
void USkill_Scout_C::OnSkillStart(class AActor* Actor, class AActor* SkillTarget, const struct FVector& Location, float Param, int SkillInstanceId)
{
	static auto fn = UObject::FindObject<UFunction>("Function Skill_Scout.Skill_Scout_C.OnSkillStart");

	USkill_Scout_C_OnSkillStart_Params params;
	params.Actor = Actor;
...
struct FText USkill_Scout_C::GetSkillDescription(class AActor* Actor, int SkillLevel)
{
	static auto fn = UObject::FindObject<UFunction>("Function Skill_Scout.Skill_Scout_C.GetSkillDescription");

	USkill_Scout_C_GetSkillDescription_Params params;
	params.Actor = Actor;

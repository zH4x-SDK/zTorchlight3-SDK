...
struct UItemSpawnTooltip_C_GetTextBlock_Params
{
...
struct UItemSpawnTooltip_C_GetWarningTextBlockWrapper_Params
{
	class UWidget*                                     ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function ItemSpawnTooltip.ItemSpawnTooltip_C.GetWarningTextBlock
struct UItemSpawnTooltip_C_GetWarningTextBlock_Params
{
...
struct UItemSpawnTooltip_C_SetText_Params
{
	struct FText                                       Text;                                                      // (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};

// Function ItemSpawnTooltip.ItemSpawnTooltip_C.ExecuteUbergraph_ItemSpawnTooltip
struct UItemSpawnTooltip_C_ExecuteUbergraph_ItemSpawnTooltip_Params
{

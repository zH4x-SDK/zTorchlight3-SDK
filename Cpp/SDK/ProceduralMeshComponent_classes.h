...
{
public:
	unsigned char                                      UnknownData_JB17[0x8];                                     // 0x0468(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_3E9N[0x6];                                     // 0x0472(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WTJK[0x4];                                     // 0x04BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

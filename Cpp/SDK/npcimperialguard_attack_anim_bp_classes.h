...
// AnimBlueprintGeneratedClass npcimperialguard_attack_anim_bp.npcimperialguard_attack_anim_bp_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass npcimperialguard_attack_anim_bp.npcimperialguard_attack_anim_bp_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_npcimperialguard_attack_anim_bp(int EntryPoint);
};

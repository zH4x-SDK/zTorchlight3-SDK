...
struct UCurrencyPickUpWidget_C_GetCurrencyIcon_Params
{
...
struct UCurrencyPickUpWidget_C_GetShowAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function CurrencyPickUpWidget.CurrencyPickUpWidget_C.GetHideAnimation
struct UCurrencyPickUpWidget_C_GetHideAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

...
struct USkill_DoubleCross_C_OnSkillRemoved_Params
{
	class AActor*                                      Actor;                                                     // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function Skill_DoubleCross.Skill_DoubleCross_C.OnSkillActorOverlap
struct USkill_DoubleCross_C_OnSkillActorOverlap_Params
{
...
struct USkill_DoubleCross_C_OnSkillEventHit01_Params
{
	class AActor*                                      Actor;                                                     // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct USkill_DoubleCross_C_GetSkillDescription_Params
{
	class AActor*                                      Actor;                                                     // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

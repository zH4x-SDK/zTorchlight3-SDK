...
// WidgetBlueprintGeneratedClass SharpshooterTrinketSpinner3.SharpshooterTrinketSpinner3_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass SharpshooterTrinketSpinner3.SharpshooterTrinketSpinner3_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_SharpshooterTrinketSpinner3(int EntryPoint);
};

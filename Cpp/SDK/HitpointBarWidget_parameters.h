...
struct UHitpointBarWidget_C_GetProgressBar_Params
{
...
struct UHitpointBarWidget_C_GetHideAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function HitpointBarWidget.HitpointBarWidget_C.GetShowAnimation
struct UHitpointBarWidget_C_GetShowAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

...
// WidgetBlueprintGeneratedClass AreaInSpokeBase.AreaInSpokeBase_C
...
public:
	...
	class UWidgetAnimation*                            loopRing;                                                  // 0x0788(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass AreaInSpokeBase.AreaInSpokeBase_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AreaInSpokeBase(int EntryPoint);
};

...
// BlueprintGeneratedClass Skill_MeleeAttack.Skill_MeleeAttack_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Skill_MeleeAttack.Skill_MeleeAttack_C");
		return ptr;
	}

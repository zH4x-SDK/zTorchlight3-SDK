...
struct UPetDisplayMenu_C_GetMenuButtonList_Params
{
...
struct UPetDisplayMenu_C_GetMenuHeader_Params
{
...
struct UPetDisplayMenu_C_GetShowAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function PetDisplayMenu.PetDisplayMenu_C.GetCanvasPanel
struct UPetDisplayMenu_C_GetCanvasPanel_Params
{
...
struct UPetDisplayMenu_C_BlueprintOnShown_Params
{
};

// Function PetDisplayMenu.PetDisplayMenu_C.ExecuteUbergraph_PetDisplayMenu
struct UPetDisplayMenu_C_ExecuteUbergraph_PetDisplayMenu_Params
{

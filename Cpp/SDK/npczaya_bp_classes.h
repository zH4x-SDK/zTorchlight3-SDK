...
// BlueprintGeneratedClass npczaya_bp.npczaya_bp_C
// 0x0008 (FullSize[0x04D0] - InheritedSize[0x04C8])
class Anpczaya_bp_C : public Anpc_quest_base_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass npczaya_bp.npczaya_bp_C");
		return ptr;
	}

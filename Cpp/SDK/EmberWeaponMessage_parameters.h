...
struct UEmberWeaponMessage_C_GetHideAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function EmberWeaponMessage.EmberWeaponMessage_C.GetElementIconImage
struct UEmberWeaponMessage_C_GetElementIconImage_Params
{
...
struct UEmberWeaponMessage_C_GetItemIconWidget_Params
{
...
struct UEmberWeaponMessage_C_GetShowAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

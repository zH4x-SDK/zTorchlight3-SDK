...
// AnimBlueprintGeneratedClass ss_anim_bp.ss_anim_bp_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass ss_anim_bp.ss_anim_bp_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_ss_anim_bp(int EntryPoint);
};

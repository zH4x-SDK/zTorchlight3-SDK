...
struct USkill_BloodDrinker_Activate_C_GetSkillDescription_Params
{
	class AActor*                                      Actor;                                                     // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct USkill_BloodDrinker_Activate_C_OnSkillActorOverlap_Params
{

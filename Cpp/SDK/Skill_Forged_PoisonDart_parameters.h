...
struct USkill_Forged_PoisonDart_C_GetDuration_Params
{
...
struct USkill_Forged_PoisonDart_C_OnSkillEventHit01_Params
{
...
struct USkill_Forged_PoisonDart_C_GetSkillDescription_Params
{
	class AActor*                                      Actor;                                                     // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

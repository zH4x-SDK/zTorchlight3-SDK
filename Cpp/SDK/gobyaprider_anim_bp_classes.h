...
// AnimBlueprintGeneratedClass gobyaprider_anim_bp.gobyaprider_anim_bp_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass gobyaprider_anim_bp.gobyaprider_anim_bp_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_gobyaprider_anim_bp(int EntryPoint);
};

...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass StatusEffect_Chilled.StatusEffect_Chilled_C");
		return ptr;
	}
	...
	void OnPreApply();
	void ExecuteUbergraph_StatusEffect_Chilled(int EntryPoint);
};

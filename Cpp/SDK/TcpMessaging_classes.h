...
public:
	...
	unsigned char                                      UnknownData_D4AI[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MHTO[0x3];                                     // 0x0055(0x0003) MISSED OFFSET (PADDING)

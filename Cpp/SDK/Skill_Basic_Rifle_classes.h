...
// BlueprintGeneratedClass Skill_Basic_Rifle.Skill_Basic_Rifle_C
// 0x0000 (FullSize[0x0540] - InheritedSize[0x0540])
class USkill_Basic_Rifle_C : public USkill
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Skill_Basic_Rifle.Skill_Basic_Rifle_C");
		return ptr;
	}

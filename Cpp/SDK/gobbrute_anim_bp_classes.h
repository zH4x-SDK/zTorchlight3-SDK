...
// AnimBlueprintGeneratedClass gobbrute_anim_bp.gobbrute_anim_bp_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass gobbrute_anim_bp.gobbrute_anim_bp_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_gobbrute_anim_bp(int EntryPoint);
};

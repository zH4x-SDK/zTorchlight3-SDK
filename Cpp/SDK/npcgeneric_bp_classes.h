...
// BlueprintGeneratedClass npcgeneric_bp.npcgeneric_bp_C
// 0x0010 (FullSize[0x04D8] - InheritedSize[0x04C8])
class Anpcgeneric_bp_C : public Anpc_quest_base_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass npcgeneric_bp.npcgeneric_bp_C");
		return ptr;
	}

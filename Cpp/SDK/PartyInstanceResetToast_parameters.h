...
struct UPartyInstanceResetToast_C_GetShowAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function PartyInstanceResetToast.PartyInstanceResetToast_C.GetBodyTextBlock
struct UPartyInstanceResetToast_C_GetBodyTextBlock_Params
{
...
struct UPartyInstanceResetToast_C_BndEvt__AcceptButton_K2Node_ComponentBoundEvent_30_OnButtonClickedEvent__DelegateSignature_Params
{
};
...
struct UPartyInstanceResetToast_C_BndEvt__DeclineButton_K2Node_ComponentBoundEvent_55_OnButtonClickedEvent__DelegateSignature_Params
{
};

// Function PartyInstanceResetToast.PartyInstanceResetToast_C.ExecuteUbergraph_PartyInstanceResetToast
struct UPartyInstanceResetToast_C_ExecuteUbergraph_PartyInstanceResetToast_Params
{

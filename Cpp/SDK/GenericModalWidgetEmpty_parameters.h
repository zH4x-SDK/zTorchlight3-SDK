...
struct UGenericModalWidgetEmpty_C_GetShowAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function GenericModalWidgetEmpty.GenericModalWidgetEmpty_C.GetContentPanel
struct UGenericModalWidgetEmpty_C_GetContentPanel_Params
{
...
struct UGenericModalWidgetEmpty_C_PreConstruct_Params
{
	bool                                               IsDesignTime;                                              // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};

// Function GenericModalWidgetEmpty.GenericModalWidgetEmpty_C.SetCloseButtonVisibility
struct UGenericModalWidgetEmpty_C_SetCloseButtonVisibility_Params
{
...
struct UGenericModalWidgetEmpty_C_BndEvt__Style_CloseButton_K2Node_ComponentBoundEvent_0_OnClosed__DelegateSignature_Params
{
};

// Function GenericModalWidgetEmpty.GenericModalWidgetEmpty_C.ExecuteUbergraph_GenericModalWidgetEmpty
struct UGenericModalWidgetEmpty_C_ExecuteUbergraph_GenericModalWidgetEmpty_Params
{

...
struct UInventoryEquippedItemWidget_C_GetEmptySlotToolTipWidget_Params
{
	class UWidget*                                     ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function InventoryEquippedItemWidget.InventoryEquippedItemWidget_C.GetSlotBGImage
struct UInventoryEquippedItemWidget_C_GetSlotBGImage_Params
{
	class UWidget*                                     ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function InventoryEquippedItemWidget.InventoryEquippedItemWidget_C.GetInventoryItemWidget
struct UInventoryEquippedItemWidget_C_GetInventoryItemWidget_Params
{
...
struct UInventoryEquippedItemWidget_C_GetSlotIconImage_Params
{

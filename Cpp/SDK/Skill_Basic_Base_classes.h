...
// BlueprintGeneratedClass Skill_Basic_Base.Skill_Basic_Base_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Skill_Basic_Base.Skill_Basic_Base_C");
		return ptr;
	}

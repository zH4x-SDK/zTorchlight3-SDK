...
{
	unsigned char                                      UnknownData_V12R[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
...
struct FLocalizedAudioTableEntryOption
{
	...
	unsigned char                                      UnknownData_D3I5[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FTLFMODAudioSectionTemplateData
{
	...
	unsigned char                                      UnknownData_LQ8K[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0UTM[0x3];                                     // 0x016D(0x0003) MISSED OFFSET (PADDING)

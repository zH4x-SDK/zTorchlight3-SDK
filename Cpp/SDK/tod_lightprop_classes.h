...
// BlueprintGeneratedClass tod_lightprop.tod_lightprop_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass tod_lightprop.tod_lightprop_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_tod_lightprop(int EntryPoint);
};

...
struct UModalFrame_C_SetTitleText_Params
{
	struct FText                                       Text;                                                      // (BlueprintVisible, BlueprintReadOnly, Parm)
};

// Function ModalFrame.ModalFrame_C.GetTitleTextBlock
struct UModalFrame_C_GetTitleTextBlock_Params
{
...
struct UModalFrame_C_PreConstruct_Params
{
...
struct UModalFrame_C_BndEvt__Style_CloseButton_K2Node_ComponentBoundEvent_0_OnClosed__DelegateSignature_Params
{
};

// Function ModalFrame.ModalFrame_C.ExecuteUbergraph_ModalFrame
struct UModalFrame_C_ExecuteUbergraph_ModalFrame_Params
{
	int                                                EntryPoint;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function ModalFrame.ModalFrame_C.OnClosed__DelegateSignature
struct UModalFrame_C_OnClosed__DelegateSignature_Params
{
};

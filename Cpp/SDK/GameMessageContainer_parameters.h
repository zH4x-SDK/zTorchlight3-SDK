...
struct UGameMessageContainer_C_GetHideAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function GameMessageContainer.GameMessageContainer_C.GetActiveWidget
struct UGameMessageContainer_C_GetActiveWidget_Params
{
...
struct UGameMessageContainer_C_GetPanel_Params
{

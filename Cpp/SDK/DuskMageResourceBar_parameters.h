...
struct UDuskMageResourceBar_C_GetTooltipAnchor_Params
{
...
struct UDuskMageResourceBar_C_GetDarkChargeBar_Params
{
...
struct UDuskMageResourceBar_C_GetLightChargeBar_Params
{
	class UActiveTraitBarWidget*                       ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

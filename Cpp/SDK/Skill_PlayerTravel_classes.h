...
// BlueprintGeneratedClass Skill_PlayerTravel.Skill_PlayerTravel_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Skill_PlayerTravel.Skill_PlayerTravel_C");
		return ptr;
	}

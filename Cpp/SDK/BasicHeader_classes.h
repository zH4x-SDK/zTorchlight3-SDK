...
// WidgetBlueprintGeneratedClass BasicHeader.BasicHeader_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BasicHeader.BasicHeader_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BasicHeader(int EntryPoint);
};

...
// Function MeleeDamageReduction.MeleeDamageReduction_C.OnSkillStart
...
void UMeleeDamageReduction_C::OnSkillStart(class AActor* Actor, class AActor* SkillTarget, const struct FVector& Location, float Param, int SkillInstanceId)
{
	static auto fn = UObject::FindObject<UFunction>("Function MeleeDamageReduction.MeleeDamageReduction_C.OnSkillStart");

	UMeleeDamageReduction_C_OnSkillStart_Params params;
	params.Actor = Actor;

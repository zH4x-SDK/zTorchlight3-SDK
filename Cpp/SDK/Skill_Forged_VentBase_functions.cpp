...
// Function Skill_Forged_VentBase.Skill_Forged_VentBase_C.OnSkillStart
...
void USkill_Forged_VentBase_C::OnSkillStart(class AActor* Actor, class AActor* SkillTarget, const struct FVector& Location, float Param, int SkillInstanceId)
{
	static auto fn = UObject::FindObject<UFunction>("Function Skill_Forged_VentBase.Skill_Forged_VentBase_C.OnSkillStart");

	USkill_Forged_VentBase_C_OnSkillStart_Params params;
	params.Actor = Actor;

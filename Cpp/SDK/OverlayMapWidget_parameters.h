...
struct UOverlayMapWidget_C_GetOverlayWidget_Params
{
...
struct UOverlayMapWidget_C_GetShowAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function OverlayMapWidget.OverlayMapWidget_C.GetFadeInAnimation
struct UOverlayMapWidget_C_GetFadeInAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function OverlayMapWidget.OverlayMapWidget_C.GetMapImageWidget
struct UOverlayMapWidget_C_GetMapImageWidget_Params
{
...
struct UOverlayMapWidget_C_GetMarkerListWidget_Params
{
...
struct UOverlayMapWidget_C_Construct_Params
{
};

// Function OverlayMapWidget.OverlayMapWidget_C.ExecuteUbergraph_OverlayMapWidget
struct UOverlayMapWidget_C_ExecuteUbergraph_OverlayMapWidget_Params
{

...
struct UFortHelpScreen_C_GetShowAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function FortHelpScreen.FortHelpScreen_C.Construct
struct UFortHelpScreen_C_Construct_Params
{
};

// Function FortHelpScreen.FortHelpScreen_C.ExecuteUbergraph_FortHelpScreen
struct UFortHelpScreen_C_ExecuteUbergraph_FortHelpScreen_Params
{

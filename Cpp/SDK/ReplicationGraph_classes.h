...
public:
	...
	unsigned char                                      UnknownData_8VOS[0x18];                                    // 0x0038(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5EZR[0xA8];                                    // 0x0050(0x00A8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7TIA[0x18];                                    // 0x00F8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_Q1L8[0x18];                                    // 0x0060(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ONTK[0x140];                                   // 0x0030(0x0140) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RIAF[0x10];                                    // 0x0178(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FLastLocationGatherInfo>             LastGatherLocations;                                       // 0x0188(0x0010) (ZeroConstructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_J0X3[0x8];                                     // 0x0198(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IZ4H[0x80];                                    // 0x01B8(0x0080) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_HBCT[0x40];                                    // 0x0058(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DW3P[0x3E0];                                   // 0x00B8(0x03E0) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_SGKC[0x8];                                     // 0x04C8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8Y6K[0xE8];                                    // 0x0050(0x00E8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LWXU[0x30];                                    // 0x00F8(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KNQY[0x98];                                    // 0x00F8(0x0098) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_N7L1[0x10];                                    // 0x00F8(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_SJUK[0x48];                                    // 0x00F8(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_N5RG[0x1E0];                                   // 0x0050(0x01E0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_CZ1O[0x10];                                    // 0x0058(0x0010) MISSED OFFSET (PADDING)

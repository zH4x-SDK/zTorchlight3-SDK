...
public:
	...
	unsigned char                                      UnknownData_06WD[0x40];                                    // 0x0058(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_262Z[0x3E0];                                   // 0x00B8(0x03E0) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_FY3G[0x8];                                     // 0x04C8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_8PO4[0x18];                                    // 0x0038(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EGB6[0xA8];                                    // 0x0050(0x00A8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5GMH[0xE8];                                    // 0x0050(0x00E8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_I0W2[0x30];                                    // 0x00F8(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4SZF[0x98];                                    // 0x00F8(0x0098) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DG7S[0x10];                                    // 0x00F8(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3MFJ[0x48];                                    // 0x00F8(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_OR0T[0x1E0];                                   // 0x0050(0x01E0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_0W2H[0x10];                                    // 0x0058(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1WX5[0x18];                                    // 0x00F8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_8L9P[0x18];                                    // 0x0060(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_1MCX[0x140];                                   // 0x0030(0x0140) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8C2A[0x10];                                    // 0x0178(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FLastLocationGatherInfo>             LastGatherLocations;                                       // 0x0188(0x0010) (ZeroConstructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_9CER[0x8];                                     // 0x0198(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QPX6[0x80];                                    // 0x01B8(0x0080) MISSED OFFSET (PADDING)

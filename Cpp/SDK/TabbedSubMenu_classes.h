...
// WidgetBlueprintGeneratedClass TabbedSubMenu.TabbedSubMenu_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass TabbedSubMenu.TabbedSubMenu_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_TabbedSubMenu(int EntryPoint);
};

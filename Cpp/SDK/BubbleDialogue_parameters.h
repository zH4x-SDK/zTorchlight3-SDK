...
struct UBubbleDialogue_C_GetShowAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function BubbleDialogue.BubbleDialogue_C.GetRichTextBlock
struct UBubbleDialogue_C_GetRichTextBlock_Params
{
...
struct UBubbleDialogue_C_PreConstruct_Params
{
	bool                                               IsDesignTime;                                              // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};

// Function BubbleDialogue.BubbleDialogue_C.ExecuteUbergraph_BubbleDialogue
struct UBubbleDialogue_C_ExecuteUbergraph_BubbleDialogue_Params
{

...
struct USocialContextMenu_C_GetAccountNameTextBlock_Params
{
...
struct USocialContextMenu_C_GetCharacterNameTextBlock_Params
{
	class UTLTextBlock*                                ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function SocialContextMenu.SocialContextMenu_C.GetDifficultyWidget
struct USocialContextMenu_C_GetDifficultyWidget_Params
{
...
struct USocialContextMenu_C_GetLevelTextBox_Params
{
	class UTLTextBlock*                                ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function SocialContextMenu.SocialContextMenu_C.GetShowAnimation
struct USocialContextMenu_C_GetShowAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function SocialContextMenu.SocialContextMenu_C.GetButtonList
struct USocialContextMenu_C_GetButtonList_Params
{
...
struct USocialContextMenu_C_ReportAbuse_Params
{
};

// Function SocialContextMenu.SocialContextMenu_C.ExecuteUbergraph_SocialContextMenu
struct USocialContextMenu_C_ExecuteUbergraph_SocialContextMenu_Params
{

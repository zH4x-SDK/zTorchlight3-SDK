...
// BlueprintGeneratedClass npchix_bp.npchix_bp_C
// 0x0010 (FullSize[0x04D8] - InheritedSize[0x04C8])
class Anpchix_bp_C : public Anpc_quest_base_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass npchix_bp.npchix_bp_C");
		return ptr;
	}

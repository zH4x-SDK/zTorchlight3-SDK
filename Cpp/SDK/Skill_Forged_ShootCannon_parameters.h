...
struct USkill_Forged_ShootCannon_C_OnSkillEventHit01_Params
{
...
struct USkill_Forged_ShootCannon_C_OnSkillDidDamage_Params
{
	class AActor*                                      Actor;                                                     // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct USkill_Forged_ShootCannon_C_GetSkillDescription_Params
{
	class AActor*                                      Actor;                                                     // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

...
// BlueprintGeneratedClass tod_spotlight.tod_spotlight_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass tod_spotlight.tod_spotlight_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_tod_spotlight(int EntryPoint);
};

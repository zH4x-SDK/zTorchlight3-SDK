...
struct UPoliciesWidget_C_GetBodyTextBlock_Params
{
...
struct UPoliciesWidget_C_GetTitleTextBlock_Params
{
	class UTextLayoutWidget*                           ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UPoliciesWidget_C_BndEvt__BaseModalWidget_K2Node_ComponentBoundEvent_8_OnClosed__DelegateSignature_Params
{
};
...
struct UPoliciesWidget_C_BndEvt__TLButton_0_K2Node_ComponentBoundEvent_47_OnButtonClickedEvent__DelegateSignature_Params
{
};

// Function PoliciesWidget.PoliciesWidget_C.ExecuteUbergraph_PoliciesWidget
struct UPoliciesWidget_C_ExecuteUbergraph_PoliciesWidget_Params
{

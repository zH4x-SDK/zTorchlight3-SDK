...
// WidgetBlueprintGeneratedClass CombatEvadeNotify.CombatEvadeNotify_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass CombatEvadeNotify.CombatEvadeNotify_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_CombatEvadeNotify(int EntryPoint);
};

...
// BlueprintGeneratedClass StatusEffect_Shasta_Taunt.StatusEffect_Shasta_Taunt_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass StatusEffect_Shasta_Taunt.StatusEffect_Shasta_Taunt_C");
		return ptr;
	}
	...
	void OnPreApply();
	void ExecuteUbergraph_StatusEffect_Shasta_Taunt(int EntryPoint);
};

...
// AnimBlueprintGeneratedClass gobgeneric_gunner_anim_bp.gobgeneric_gunner_anim_bp_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass gobgeneric_gunner_anim_bp.gobgeneric_gunner_anim_bp_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_gobgeneric_gunner_anim_bp(int EntryPoint);
};

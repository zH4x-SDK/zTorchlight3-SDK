...
struct USkill_HarvestStoneMetal_C_OnSkillEventHit01_Params
{
...
struct USkill_HarvestStoneMetal_C_OnSkillStop_Params
{
	class AActor*                                      Actor;                                                     // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function Skill_HarvestStoneMetal.Skill_HarvestStoneMetal_C.OnSkillStart
struct USkill_HarvestStoneMetal_C_OnSkillStart_Params
{
	class AActor*                                      Actor;                                                     // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

...
// BlueprintGeneratedClass SFX_PLAYER_Elemental_FIRE.SFX_PLAYER_Elemental_FIRE_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass SFX_PLAYER_Elemental_FIRE.SFX_PLAYER_Elemental_FIRE_C");
		return ptr;
	}

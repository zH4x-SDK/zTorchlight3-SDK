...
struct USkillDescriptionSimple_C_GetSkillDisplayWidget_Params
{
...
struct USkillDescriptionSimple_C_GetLevelBonusListWidget_Params
{
...
struct USkillDescriptionSimple_C_GetCooldownText_Params
{
...
struct USkillDescriptionSimple_C_GetEnergyCostText_Params
{
	class UTLTextBlock*                                ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

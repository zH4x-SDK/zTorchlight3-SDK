...
struct UMiniPetInfoWidget_C_GetContainerWidget_Params
{
	class UWidget*                                     ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function MiniPetInfoWidget.MiniPetInfoWidget_C.GetHealthProgressBar
struct UMiniPetInfoWidget_C_GetHealthProgressBar_Params
{
...
struct UMiniPetInfoWidget_C_GetBorderWidget_Params
{
...
struct UMiniPetInfoWidget_C_GetPortraitImage_Params
{

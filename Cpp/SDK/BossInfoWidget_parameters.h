...
struct UBossInfoWidget_C_GetOverallVisibilityContainer_Params
{
	class UWidget*                                     ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function BossInfoWidget.BossInfoWidget_C.GetPanel
struct UBossInfoWidget_C_GetPanel_Params
{
...
struct UBossInfoWidget_C_OnSelectedActorChanged_Params
{
};

// Function BossInfoWidget.BossInfoWidget_C.ExecuteUbergraph_BossInfoWidget
struct UBossInfoWidget_C_ExecuteUbergraph_BossInfoWidget_Params
{

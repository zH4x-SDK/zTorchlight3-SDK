...
// BlueprintGeneratedClass TLEffect_champion_indicator_regular_01.TLEffect_champion_indicator_regular_01_C
// 0x0020 (FullSize[0x0280] - InheritedSize[0x0260])
class ATLEffect_champion_indicator_regular_01_C : public ATLEffect
{
public:
	class UParticleSystemComponent*                    vfx_champion_regular_indicator_light_01_p;                 // 0x0260(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TLEffect_champion_indicator_regular_01.TLEffect_champion_indicator_regular_01_C");
		return ptr;
	}

...
// WidgetBlueprintGeneratedClass ModalDialog.ModalDialog_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass ModalDialog.ModalDialog_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_ModalDialog(int EntryPoint);
};

...
struct UAreaInSpokeBase_C_OnFocusReceived_Params
{
...
struct UAreaInSpokeBase_C_Get_AreaName_Visibility_1_Params
{
	UMG_ESlateVisibility                               ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function AreaInSpokeBase.AreaInSpokeBase_C.GetAreaNameWithLevelText
struct UAreaInSpokeBase_C_GetAreaNameWithLevelText_Params
{
...
struct UAreaInSpokeBase_C_GetSpokeQuestIcon_Params
{
...
struct UAreaInSpokeBase_C_GetNeighborList_Params
{
...
struct UAreaInSpokeBase_C_GetAreaNameText_Params
{
	class UTLTextBlock*                                ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function AreaInSpokeBase.AreaInSpokeBase_C.GetButton
struct UAreaInSpokeBase_C_GetButton_Params
{
...
struct UAreaInSpokeBase_C_GetPortraitFrameVisibility_Params
{
	UMG_ESlateVisibility                               ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function AreaInSpokeBase.AreaInSpokeBase_C.GetYouAreHereImage
struct UAreaInSpokeBase_C_GetYouAreHereImage_Params
{
	class UTLImage*                                    ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function AreaInSpokeBase.AreaInSpokeBase_C.PreConstruct
struct UAreaInSpokeBase_C_PreConstruct_Params
{
	bool                                               IsDesignTime;                                              // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};

// Function AreaInSpokeBase.AreaInSpokeBase_C.Construct
struct UAreaInSpokeBase_C_Construct_Params
{
};
...
struct UAreaInSpokeBase_C_BndEvt__Button_2_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature_Params
{
};

// Function AreaInSpokeBase.AreaInSpokeBase_C.OnFocusLost
struct UAreaInSpokeBase_C_OnFocusLost_Params
{
	struct FFocusEvent                                 InFocusEvent;                                              // (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
};

// Function AreaInSpokeBase.AreaInSpokeBase_C.ExecuteUbergraph_AreaInSpokeBase
struct UAreaInSpokeBase_C_ExecuteUbergraph_AreaInSpokeBase_Params
{

...
struct UFriendsMenu_C_GetbIsEnabled_1_Params
{
	bool                                               ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor)
};

// Function FriendsMenu.FriendsMenu_C.GetFriendsList
struct UFriendsMenu_C_GetFriendsList_Params
{
...
struct UFriendsMenu_C_BndEvt__ViewProfileButton_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature_Params
{
};

// Function FriendsMenu.FriendsMenu_C.ExecuteUbergraph_FriendsMenu
struct UFriendsMenu_C_ExecuteUbergraph_FriendsMenu_Params
{

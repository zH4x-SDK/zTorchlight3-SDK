...
// WidgetBlueprintGeneratedClass SharpshooterTrinketSpinner4.SharpshooterTrinketSpinner4_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass SharpshooterTrinketSpinner4.SharpshooterTrinketSpinner4_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_SharpshooterTrinketSpinner4(int EntryPoint);
};

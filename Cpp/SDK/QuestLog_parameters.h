...
struct UQuestLog_C_GetAdventureQuestsWrapper_Params
{
	class UWidget*                                     ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function QuestLog.QuestLog_C.GetStoryQuestsWrapper
struct UQuestLog_C_GetStoryQuestsWrapper_Params
{
	class UWidget*                                     ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function QuestLog.QuestLog_C.GetTutorialQuestsWidget
struct UQuestLog_C_GetTutorialQuestsWidget_Params
{
...
struct UQuestLog_C_GetTutorialQuestsWrapper_Params
{
	class UWidget*                                     ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function QuestLog.QuestLog_C.GetNextListBinding
struct UQuestLog_C_GetNextListBinding_Params
{
...
struct UQuestLog_C_GetQuestScrollBox_Params
{
...
struct UQuestLog_C_GetAdventureQuestsWidget_Params
{
	class UQuestListWidget*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function QuestLog.QuestLog_C.GetStoryQuestsWidget
struct UQuestLog_C_GetStoryQuestsWidget_Params
{
	class UQuestListWidget*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

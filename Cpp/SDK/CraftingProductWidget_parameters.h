...
struct UCraftingProductWidget_C_GetDisplayNameText_Params
{
...
struct UCraftingProductWidget_C_GetResourceWidget_Params
{
...
struct UCraftingProductWidget_C_PreConstruct_Params
{
	bool                                               IsDesignTime;                                              // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};

// Function CraftingProductWidget.CraftingProductWidget_C.ExecuteUbergraph_CraftingProductWidget
struct UCraftingProductWidget_C_ExecuteUbergraph_CraftingProductWidget_Params
{

...
struct URelicActiveWidget_C_GetOnCooldownWidget_Params
{
	class UWidget*                                     ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function RelicActiveWidget.RelicActiveWidget_C.GetCooldownProgress
struct URelicActiveWidget_C_GetCooldownProgress_Params
{
...
struct URelicActiveWidget_C_GetCooldownTextBlock_Params
{
...
struct URelicActiveWidget_C_GetOffCooldownWidget_Params
{
	class UWidget*                                     ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function RelicActiveWidget.RelicActiveWidget_C.GetOffCooldownAnimation
struct URelicActiveWidget_C_GetOffCooldownAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function RelicActiveWidget.RelicActiveWidget_C.GetSkillDisplay
struct URelicActiveWidget_C_GetSkillDisplay_Params
{
...
struct URelicActiveWidget_C_GetTooltipWidget_1_Params
{
	class UWidget*                                     ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function RelicActiveWidget.RelicActiveWidget_C.GetSkillHotkey
struct URelicActiveWidget_C_GetSkillHotkey_Params
{

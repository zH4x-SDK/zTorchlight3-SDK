...
// BlueprintGeneratedClass io_prop_fishb_animated_bp.io_prop_fishb_animated_bp_C
// 0x0018 (FullSize[0x0238] - InheritedSize[0x0220])
class Aio_prop_fishb_animated_bp_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass io_prop_fishb_animated_bp.io_prop_fishb_animated_bp_C");
		return ptr;
	}

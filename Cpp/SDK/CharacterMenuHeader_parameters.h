...
struct UCharacterMenuHeader_C_GetHideAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function CharacterMenuHeader.CharacterMenuHeader_C.GetShowAnimation
struct UCharacterMenuHeader_C_GetShowAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function CharacterMenuHeader.CharacterMenuHeader_C.GetCanvasPanel
struct UCharacterMenuHeader_C_GetCanvasPanel_Params
{
...
struct UCharacterMenuHeader_C_GetMenuButtonList_Params
{
...
struct UCharacterMenuHeader_C_Construct_Params
{
};

// Function CharacterMenuHeader.CharacterMenuHeader_C.ExecuteUbergraph_CharacterMenuHeader
struct UCharacterMenuHeader_C_ExecuteUbergraph_CharacterMenuHeader_Params
{

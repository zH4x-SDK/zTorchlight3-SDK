...
// WidgetBlueprintGeneratedClass WeaponHelpScreen.WeaponHelpScreen_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WeaponHelpScreen.WeaponHelpScreen_C");
		return ptr;
	}

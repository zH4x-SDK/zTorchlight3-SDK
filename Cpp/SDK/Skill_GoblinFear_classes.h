...
// BlueprintGeneratedClass Skill_GoblinFear.Skill_GoblinFear_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Skill_GoblinFear.Skill_GoblinFear_C");
		return ptr;
	}

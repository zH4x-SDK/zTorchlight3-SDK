...
// BlueprintGeneratedClass SFX_Elemental_ICE.SFX_Elemental_ICE_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass SFX_Elemental_ICE.SFX_Elemental_ICE_C");
		return ptr;
	}

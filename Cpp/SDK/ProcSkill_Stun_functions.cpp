...
void UProcSkill_Stun_C::OnSkillStart(class AActor* Actor, class AActor* SkillTarget, const struct FVector& Location, float Param, int SkillInstanceId)
{
	static auto fn = UObject::FindObject<UFunction>("Function ProcSkill_Stun.ProcSkill_Stun_C.OnSkillStart");

	UProcSkill_Stun_C_OnSkillStart_Params params;
	params.Actor = Actor;

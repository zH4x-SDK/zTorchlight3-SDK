...
struct UCraftingEntryContainer_C_GetCraftingQueueEntryWidget_Blueprint_Params
{
...
struct UCraftingEntryContainer_C_GetCraftingRecipeWidget_Blueprint_Params
{
...
struct UCraftingEntryContainer_C_GetWidgetSwitcher_Params
{
...
struct UCraftingEntryContainer_C_BlueprintSetRecipeEnabled_Params
{
	bool                                               bEnabled;                                                  // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};

// Function CraftingEntryContainer.CraftingEntryContainer_C.ExecuteUbergraph_CraftingEntryContainer
struct UCraftingEntryContainer_C_ExecuteUbergraph_CraftingEntryContainer_Params
{

...
// BlueprintGeneratedClass PotionPickupHyvid.PotionPickupHyvid_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass PotionPickupHyvid.PotionPickupHyvid_C");
		return ptr;
	}

...
struct ULogTaskWidget_C_GetShowProgressAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function LogTaskWidget.LogTaskWidget_C.GetTaskTextBlock
struct ULogTaskWidget_C_GetTaskTextBlock_Params
{
...
struct ULogTaskWidget_C_GetCheckmarkColorAndOpacity_Params
{

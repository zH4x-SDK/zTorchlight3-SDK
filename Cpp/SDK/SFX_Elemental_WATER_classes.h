...
// BlueprintGeneratedClass SFX_Elemental_WATER.SFX_Elemental_WATER_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass SFX_Elemental_WATER.SFX_Elemental_WATER_C");
		return ptr;
	}

...
// AnimBlueprintGeneratedClass mossrat_anim_bp.mossrat_anim_bp_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass mossrat_anim_bp.mossrat_anim_bp_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_mossrat_anim_bp(int EntryPoint);
};

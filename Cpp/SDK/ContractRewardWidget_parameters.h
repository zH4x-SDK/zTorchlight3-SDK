...
struct UContractRewardWidget_C_GetRewardNameTextBlock_Params
{
...
struct UContractRewardWidget_C_GetCraftingProductWidget_Params
{
...
struct UContractRewardWidget_C_Construct_Params
{
};
...
struct UContractRewardWidget_C_BndEvt__Button_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature_Params
{
};

// Function ContractRewardWidget.ContractRewardWidget_C.PlayClaimAnimation
struct UContractRewardWidget_C_PlayClaimAnimation_Params
{
	int                                                Index;                                                     // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function ContractRewardWidget.ContractRewardWidget_C.ResetAnimation
struct UContractRewardWidget_C_ResetAnimation_Params
{
};

// Function ContractRewardWidget.ContractRewardWidget_C.ExecuteUbergraph_ContractRewardWidget
struct UContractRewardWidget_C_ExecuteUbergraph_ContractRewardWidget_Params
{

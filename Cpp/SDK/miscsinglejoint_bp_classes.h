...
// AnimBlueprintGeneratedClass miscsinglejoint_bp.miscsinglejoint_bp_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass miscsinglejoint_bp.miscsinglejoint_bp_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_miscsinglejoint_bp(int EntryPoint);
};

...
struct UPotionWidget_C_GetNumPotionsText_Params
{
...
struct UPotionWidget_C_GetDescriptionAnchor_Params
{
...
struct UPotionWidget_C_GetUseLastPotionAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function PotionWidget.PotionWidget_C.GetUsePotionAnimation
struct UPotionWidget_C_GetUsePotionAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function PotionWidget.PotionWidget_C.GetSkillHotkey
struct UPotionWidget_C_GetSkillHotkey_Params
{
...
struct UPotionWidget_C_ExecuteUbergraph_PotionWidget_Params
{

...
struct UInbox_C_GetShowAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function Inbox.Inbox_C.GetInboxEntryList
struct UInbox_C_GetInboxEntryList_Params
{
...
struct UInbox_C_BndEvt__CloseMenuButton_K2Node_ComponentBoundEvent_0_OnClosed__DelegateSignature_Params
{
};

// Function Inbox.Inbox_C.ExecuteUbergraph_Inbox
struct UInbox_C_ExecuteUbergraph_Inbox_Params
{

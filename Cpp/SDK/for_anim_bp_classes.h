...
// AnimBlueprintGeneratedClass for_anim_bp.for_anim_bp_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass for_anim_bp.for_anim_bp_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_for_anim_bp(int EntryPoint);
};

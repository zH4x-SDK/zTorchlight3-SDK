...
// BlueprintGeneratedClass for_charactercreate_sequencer.for_charactercreate_sequencer_C
...
public:
	...
	class USkeletalMeshComponent*                      WeaponL;                                                   // 0x0228(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	...
	class USkeletalMeshComponent*                      Weapon;                                                    // 0x0268(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass for_charactercreate_sequencer.for_charactercreate_sequencer_C");
		return ptr;
	}

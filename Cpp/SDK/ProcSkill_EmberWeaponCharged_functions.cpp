...
// Function ProcSkill_EmberWeaponCharged.ProcSkill_EmberWeaponCharged_C.OnSkillStart
...
void UProcSkill_EmberWeaponCharged_C::OnSkillStart(class AActor* Actor, class AActor* SkillTarget, const struct FVector& Location, float Param, int SkillInstanceId)
{
	static auto fn = UObject::FindObject<UFunction>("Function ProcSkill_EmberWeaponCharged.ProcSkill_EmberWeaponCharged_C.OnSkillStart");

	UProcSkill_EmberWeaponCharged_C_OnSkillStart_Params params;
	params.Actor = Actor;

...
struct UPetStored_C_GetReleaseButtonWidget_Params
{
	class UWidget*                                     ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function PetStored.PetStored_C.GetPetTypeTextBlock
struct UPetStored_C_GetPetTypeTextBlock_Params
{
...
struct UPetStored_C_GetRarityTextBlock_Params
{
	class UTLTextBlock*                                ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function PetStored.PetStored_C.GetPetSkillList
struct UPetStored_C_GetPetSkillList_Params
{
...
struct UPetStored_C_GetPetIconWidget_Params
{
...
struct UPetStored_C_GetPetName_Params
{
	class UTLTextBlock*                                ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function PetStored.PetStored_C.PlayChangedAnimation
struct UPetStored_C_PlayChangedAnimation_Params
{
};

// Function PetStored.PetStored_C.BndEvt__CloseButton_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature
struct UPetStored_C_BndEvt__CloseButton_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature_Params
{
};

// Function PetStored.PetStored_C.ExecuteUbergraph_PetStored
struct UPetStored_C_ExecuteUbergraph_PetStored_Params
{

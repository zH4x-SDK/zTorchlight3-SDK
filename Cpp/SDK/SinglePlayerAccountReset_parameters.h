...
struct USinglePlayerAccountReset_C_SetResetProgress_Params
{
	float                                              Progress;                                                  // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function SinglePlayerAccountReset.SinglePlayerAccountReset_C.Tick
struct USinglePlayerAccountReset_C_Tick_Params
{
...
struct USinglePlayerAccountReset_C_BlueprintOnShown_Params
{
};
...
struct USinglePlayerAccountReset_C_BndEvt__TLButton_12_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature_Params
{
};
...
struct USinglePlayerAccountReset_C_BndEvt__ResetButton_K2Node_ComponentBoundEvent_0_OnButtonReleasedEvent__DelegateSignature_Params
{
};
...
struct USinglePlayerAccountReset_C_BndEvt__ResetButton_K2Node_ComponentBoundEvent_3_OnButtonPressedEvent__DelegateSignature_Params
{
};

// Function SinglePlayerAccountReset.SinglePlayerAccountReset_C.ExecuteUbergraph_SinglePlayerAccountReset
struct USinglePlayerAccountReset_C_ExecuteUbergraph_SinglePlayerAccountReset_Params
{

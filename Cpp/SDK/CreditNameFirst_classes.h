...
// WidgetBlueprintGeneratedClass CreditNameFirst.CreditNameFirst_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass CreditNameFirst.CreditNameFirst_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_CreditNameFirst(int EntryPoint);
};

...
struct UMapPanelWidget_C_GetSpokeWrapper_Params
{
...
struct UMapPanelWidget_C_GetQuestLog_Params
{
...
struct UMapPanelWidget_C_GetHideAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function MapPanelWidget.MapPanelWidget_C.GetShowAnimation
struct UMapPanelWidget_C_GetShowAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

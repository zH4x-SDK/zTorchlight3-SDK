...
// AnimBlueprintGeneratedClass tinymouse_anim_bp.tinymouse_anim_bp_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass tinymouse_anim_bp.tinymouse_anim_bp_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_tinymouse_anim_bp(int EntryPoint);
};

...
// BlueprintGeneratedClass npckenik_intro_bp.npckenik_intro_bp_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass npckenik_intro_bp.npckenik_intro_bp_C");
		return ptr;
	}

...
// WidgetBlueprintGeneratedClass TabbedSubMenuButtonLarge.TabbedSubMenuButtonLarge_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass TabbedSubMenuButtonLarge.TabbedSubMenuButtonLarge_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_TabbedSubMenuButtonLarge(int EntryPoint);
};

...
// Function Skill_Legendary_CoalLaunchRain.Skill_Legendary_CoalLaunchRain_C.OnSkillStart
...
void USkill_Legendary_CoalLaunchRain_C::OnSkillStart(class AActor* Actor, class AActor* SkillTarget, const struct FVector& Location, float Param, int SkillInstanceId)
{
	static auto fn = UObject::FindObject<UFunction>("Function Skill_Legendary_CoalLaunchRain.Skill_Legendary_CoalLaunchRain_C.OnSkillStart");

	USkill_Legendary_CoalLaunchRain_C_OnSkillStart_Params params;
	params.Actor = Actor;

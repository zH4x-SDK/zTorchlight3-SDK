...
struct UCraftingPanel_C_GetCurrencyWidget_Params
{
...
struct UCraftingPanel_C_GetMenuButtonList_Params
{
...
struct UCraftingPanel_C_GetCanvasPanel_Params
{
...
struct UCraftingPanel_C_GetShowAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function CraftingPanel.CraftingPanel_C.BlueprintOnShown
struct UCraftingPanel_C_BlueprintOnShown_Params
{
};

// Function CraftingPanel.CraftingPanel_C.ExecuteUbergraph_CraftingPanel
struct UCraftingPanel_C_ExecuteUbergraph_CraftingPanel_Params
{

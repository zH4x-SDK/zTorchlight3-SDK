...
// WidgetBlueprintGeneratedClass MultiPlayerAccountReset.MultiPlayerAccountReset_C
...
public:
	...
	unsigned char                                      UnknownData_IOBH[0x3];                                     // 0x0DF1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass MultiPlayerAccountReset.MultiPlayerAccountReset_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_MultiPlayerAccountReset(int EntryPoint);
};

...
struct UPetIconWidget_C_GetComparisonMenuAnchor_Params
{
...
struct UPetIconWidget_C_GetPetIconImage_Params
{
...
struct UPetIconWidget_C_GetItemIconBackground_Params
{
	class UTLImage*                                    ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function PetIconWidget.PetIconWidget_C.GetItemIconBorder
struct UPetIconWidget_C_GetItemIconBorder_Params
{

...
struct UEmberWeaponSkills_C_GetDefaultEmberWeaponWidget_Params
{
	class UWidget*                                     ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function EmberWeaponSkills.EmberWeaponSkills_C.GetSkillsInTabList
struct UEmberWeaponSkills_C_GetSkillsInTabList_Params
{
...
struct UEmberWeaponSkills_C_GetSkillTabBackground_Params
{

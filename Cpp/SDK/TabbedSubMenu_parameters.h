...
struct UTabbedSubMenu_C_GetMenuButtonList_Params
{
...
struct UTabbedSubMenu_C_PreConstruct_Params
{
	bool                                               IsDesignTime;                                              // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};

// Function TabbedSubMenu.TabbedSubMenu_C.ExecuteUbergraph_TabbedSubMenu
struct UTabbedSubMenu_C_ExecuteUbergraph_TabbedSubMenu_Params
{

...
struct UDungeonLevelCard_C_GetStateSwitchers_Params
{
...
struct UDungeonLevelCard_C_GetLevelTextBlocks_Params
{
...
struct UDungeonLevelCard_C_GetSelectAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function DungeonLevelCard.DungeonLevelCard_C.GetStartFocusAnimation
struct UDungeonLevelCard_C_GetStartFocusAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function DungeonLevelCard.DungeonLevelCard_C.Construct
struct UDungeonLevelCard_C_Construct_Params
{
};
...
struct UDungeonLevelCard_C_BndEvt__TLButton_235_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature_Params
{
};

// Function DungeonLevelCard.DungeonLevelCard_C.ExecuteUbergraph_DungeonLevelCard
struct UDungeonLevelCard_C_ExecuteUbergraph_DungeonLevelCard_Params
{

...
struct FSimulationStageMetaData
{
	...
	unsigned char                                      UnknownData_RQIR[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_SQBB[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FNiagaraCompileEvent
{
	...
	unsigned char                                      UnknownData_AM2O[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

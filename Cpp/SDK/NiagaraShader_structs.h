...
{
	unsigned char                                      UnknownData_5B4H[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FNiagaraCompileEvent
{
	...
	unsigned char                                      UnknownData_L7XU[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSimulationStageMetaData
{
	...
	unsigned char                                      UnknownData_CKEM[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

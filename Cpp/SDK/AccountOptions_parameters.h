...
struct UAccountOptions_C_On_UnlinkLIstWidget_GetNextListBinding_1_Params
{
...
struct UAccountOptions_C_GetButtonList_Params
{
	class UListWidget*                                 ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function AccountOptions.AccountOptions_C.On_ButtonListMultiplayer_GetNextListBinding_1
struct UAccountOptions_C_On_ButtonListMultiplayer_GetNextListBinding_1_Params
{
	class UListWidget*                                 CurrentList;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	SlateCore_EUINavigation                            NavDirection;                                              // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UListWidget*                                 ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UAccountOptions_C_On_ButtonListSinglePlayer_GetNextListBinding_1_Params
{
	class UListWidget*                                 CurrentList;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	SlateCore_EUINavigation                            NavDirection;                                              // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UListWidget*                                 ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UAccountOptions_C_Construct_Params
{
};

// Function AccountOptions.AccountOptions_C.BlueprintOnShown
struct UAccountOptions_C_BlueprintOnShown_Params
{
};
...
struct UAccountOptions_C_BndEvt__SinglePlayerResetButton_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature_Params
{
};
...
struct UAccountOptions_C_BndEvt__MultiplayerResetButton_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature_Params
{
};

// Function AccountOptions.AccountOptions_C.UpdateSinglePlayerHeroCount
struct UAccountOptions_C_UpdateSinglePlayerHeroCount_Params
{
...
struct UAccountOptions_C_UpdateMultiplayerHeroCount_Params
{
	int                                                HeroCount;                                                 // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UAccountOptions_C_BndEvt__UnlinkAccountButton_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature_Params
{
};

// Function AccountOptions.AccountOptions_C.HideMultiplayerLoadingSpinner
struct UAccountOptions_C_HideMultiplayerLoadingSpinner_Params
{
};

// Function AccountOptions.AccountOptions_C.ExecuteUbergraph_AccountOptions
struct UAccountOptions_C_ExecuteUbergraph_AccountOptions_Params
{

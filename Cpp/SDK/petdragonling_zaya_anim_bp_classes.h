...
// AnimBlueprintGeneratedClass petdragonling_zaya_anim_bp.petdragonling_zaya_anim_bp_C
// 0x0170 (FullSize[0x0780] - InheritedSize[0x0610])
class Upetdragonling_zaya_anim_bp_C : public UTLAnimInstance
{
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass petdragonling_zaya_anim_bp.petdragonling_zaya_anim_bp_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_petdragonling_zaya_anim_bp(int EntryPoint);
};

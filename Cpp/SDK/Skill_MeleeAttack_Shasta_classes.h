...
// BlueprintGeneratedClass Skill_MeleeAttack_Shasta.Skill_MeleeAttack_Shasta_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Skill_MeleeAttack_Shasta.Skill_MeleeAttack_Shasta_C");
		return ptr;
	}

...
// AnimBlueprintGeneratedClass petowl_anim_bp.petowl_anim_bp_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass petowl_anim_bp.petowl_anim_bp_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_petowl_anim_bp(int EntryPoint);
};

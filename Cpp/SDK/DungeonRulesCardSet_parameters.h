...
struct UDungeonRulesCardSet_C_GetCardHideAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function DungeonRulesCardSet.DungeonRulesCardSet_C.GetCardShowAnimation
struct UDungeonRulesCardSet_C_GetCardShowAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function DungeonRulesCardSet.DungeonRulesCardSet_C.GetCardListWidget
struct UDungeonRulesCardSet_C_GetCardListWidget_Params
{

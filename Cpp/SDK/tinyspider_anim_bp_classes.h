...
// AnimBlueprintGeneratedClass tinyspider_anim_bp.tinyspider_anim_bp_C
// 0x0170 (FullSize[0x0780] - InheritedSize[0x0610])
class Utinyspider_anim_bp_C : public UTLAnimInstance
{
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass tinyspider_anim_bp.tinyspider_anim_bp_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_tinyspider_anim_bp(int EntryPoint);
};

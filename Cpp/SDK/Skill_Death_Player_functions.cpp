...
// Function Skill_Death_Player.Skill_Death_Player_C.OnSkillStart
...
void USkill_Death_Player_C::OnSkillStart(class AActor* Actor, class AActor* SkillTarget, const struct FVector& Location, float Param, int SkillInstanceId)
{
	static auto fn = UObject::FindObject<UFunction>("Function Skill_Death_Player.Skill_Death_Player_C.OnSkillStart");

	USkill_Death_Player_C_OnSkillStart_Params params;
	params.Actor = Actor;

...
// BlueprintGeneratedClass Skill_PetLifeSteal.Skill_PetLifeSteal_C
...
public:
	...
	float                                              LifestealAmount;                                           // 0x0544(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<struct FText>                               NewVar_1;                                                  // 0x0548(0x0010) (Edit, BlueprintVisible, DisableEditOnInstance)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Skill_PetLifeSteal.Skill_PetLifeSteal_C");
		return ptr;
	}

...
struct ABasePotion_C_BndEvt__ItemOnGround_K2Node_ComponentBoundEvent_0_DoPickedUpDelegate__DelegateSignature_Params
{
	class AActor*                                      Actor;                                                     // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function BasePotion.BasePotion_C.ExecuteUbergraph_BasePotion
struct ABasePotion_C_ExecuteUbergraph_BasePotion_Params
{

...
// AnimBlueprintGeneratedClass gobrider_anim_bp.gobrider_anim_bp_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass gobrider_anim_bp.gobrider_anim_bp_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_gobrider_anim_bp(int EntryPoint);
};

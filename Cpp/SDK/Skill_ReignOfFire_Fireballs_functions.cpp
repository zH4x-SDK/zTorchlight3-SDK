...
// Function Skill_ReignOfFire_Fireballs.Skill_ReignOfFire_Fireballs_C.OnSkillStart
...
void USkill_ReignOfFire_Fireballs_C::OnSkillStart(class AActor* Actor, class AActor* SkillTarget, const struct FVector& Location, float Param, int SkillInstanceId)
{
	static auto fn = UObject::FindObject<UFunction>("Function Skill_ReignOfFire_Fireballs.Skill_ReignOfFire_Fireballs_C.OnSkillStart");

	USkill_ReignOfFire_Fireballs_C_OnSkillStart_Params params;
	params.Actor = Actor;

...
struct UContractClaimChest_C_GetClaimAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function ContractClaimChest.ContractClaimChest_C.GetShowAnimation
struct UContractClaimChest_C_GetShowAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function ContractClaimChest.ContractClaimChest_C.GetRewardList
struct UContractClaimChest_C_GetRewardList_Params
{
...
struct UContractClaimChest_C_Construct_Params
{
};
...
struct UContractClaimChest_C_BndEvt__ClaimButton_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature_Params
{
};

// Function ContractClaimChest.ContractClaimChest_C.ExecuteUbergraph_ContractClaimChest
struct UContractClaimChest_C_ExecuteUbergraph_ContractClaimChest_Params
{

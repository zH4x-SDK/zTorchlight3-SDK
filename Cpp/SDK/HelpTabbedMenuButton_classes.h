...
// WidgetBlueprintGeneratedClass HelpTabbedMenuButton.HelpTabbedMenuButton_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass HelpTabbedMenuButton.HelpTabbedMenuButton_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_HelpTabbedMenuButton(int EntryPoint);
};
